...
router.get('/', authenticate, requireRole([ROLES.ADMINISTRADOR, ROLES.PERSONAL, ROLES.CLIENTE]), getUsuarios)
router.get('/:id', authenticate, requireRole([ROLES.ADMINISTRADOR, ROLES.PERSONAL, ROLES.CLIENTE]), getUsuarioById)
